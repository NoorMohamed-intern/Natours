...
})({"aLu1f":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const logout = async ()=>{
    try {
        ...
        _alerts.showAlert('error', 'Error logging in try again later sry');
    }
};
...
const bookTour = async (tourId)=>{
    const stripe = Stripe('pk_test_51KrF4OSBx1fAtecdsMMCTOAkCN5tvOZVHeWZ3Y6ycjXfvRRZVpJsRKO0qXdh9nt3INkQU4pZvLPh1eYxBThZkKLA00NHbql4cD');
    try {
...
},{"axios":"jo6P5","./alerts":"6Mcnf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["aLu1f","f2QDv"], "f2QDv", "parcelRequire11c7")
